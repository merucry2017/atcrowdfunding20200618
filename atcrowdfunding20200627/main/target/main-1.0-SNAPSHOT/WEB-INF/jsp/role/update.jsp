                ...
                <div class="panel-body">
                    <form id="updateForm" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fname" placeholder="请输入角色名称" value="${role.name}">
                            <p class="help-block label label-warning">请输入合法的角色名称, 格式为： xxxx - xxxx 例如：PM - 项目经理</p>
                        </div>
...
<script type="text/javascript">
    ...
    $("#updateBtn").click(function () {
        ...
        if($.trim(fname.val()) == ""){
            ...
            layer.msg("角色名称不能为空，请重新输入！", {time:1000, icon:5, shift:6}, function () {
                fname.val("");
                fname.focus();
            });
            return false;
